...
def yellowButtonAction(app):
    print("Updated yellow button clicked!")
...
def appStarted(app):
    ...
    app.buttons['splash'] += [button(1/2, 11/14, 1/3, 1/14, 'Updated Yellow Button', yellowButtonAction, 'yellow')]
